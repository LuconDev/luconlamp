...
#define NUMPIXELS1      3 // number of LEDs on strip
...
unsigned long intervals [] = { 2000, 20, 50, 100 } ; // speed for each pattern

const byte button = 12; // pin to connect button switch to between pin and ground
...
void rainbow() { // modified from Adafruit example to make it a state machine
  static uint16_t j=0;
  Serial.print("1- j: "); Serial.println(j);
  ...
  Serial.print("2- j: "); Serial.println(j);
}
